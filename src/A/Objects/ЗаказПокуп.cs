...
namespace IIS.A
{
    ...
    [View("ЗаказПокупL", new string[] {
            ...
            "Контрагенты.Контрагент as \'Контрагент\'",
            "Организации.Организация as \'Организация\'"})]
    public class ЗаказПокуп : IIS.A.ОтчетОПродажах
    {
        ...
        public override IIS.A.СостОплаты СостОплат
        {
            get
            {
                ...
                IIS.A.СостОплаты result = base.СостОплат;
        ...
        public override IIS.A.СостОгрузки СостОтгруз
        {
            get
            {
                ...
                IIS.A.СостОгрузки result = base.СостОтгруз;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказПокупE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПокупE", typeof(IIS.A.ЗаказПокуп));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказПокупL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПокупL", typeof(IIS.A.ЗаказПокуп));
                }
            }
        }
    }
